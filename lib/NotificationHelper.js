// TODO: Need to configure the XCode changes for iOS
...
class NotificationHelper {
  ...
  __handleNotification(payload, userClicked, notification) {
    ...
    if (payload && userClicked) {
      if (!this.__dispatch) {
        console.error('Missing dispatch referenced')
        return
      }

      this.__dispatch(goToScene(payload.toScene(), payload.toSceneParams()))
    } else {
