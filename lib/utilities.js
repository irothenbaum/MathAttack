...
import {black, darkGrey, DimmedColors, lightGrey, NeonColors, white} from '../styles/colors'
 ...
 */
const generateRandomVibratePattern = (startOffset, endOffset, sliceCount) => {
 ...
 * @returns {*}
 */
export function getOutOfFocusStylesForAnimation(animation, startOffset, endOffset) {
  return {
    top: animation.interpolate(generateRandomVibratePattern(startOffset, endOffset, 3)),
    left: animation.interpolate(generateRandomVibratePattern(startOffset, endOffset, 3)),
  }
}
