...
export function getOutOfFocusStylesForAnimation(animation, startOffset, endOffset) {
  return {
    top: animation.interpolate(generateRandomVibratePattern(startOffset, endOffset, 2)),
    left: animation.interpolate(generateRandomVibratePattern(startOffset, endOffset, 2)),
  }
}
